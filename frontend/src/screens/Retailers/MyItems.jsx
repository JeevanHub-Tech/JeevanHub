                  ...
                  <tr key={item._id} style={{ backgroundColor: isSelected ? '#f8fafc' : 'transparent' }}>
                    ...
                    <td className="col-image" onClick={() => openGallery(item)} style={{ cursor: 'pointer' }} title="View Images">
                      {item.images && item.images.length > 0 ? (
                        <img 
                          src={item.images[0].startsWith('http') ? item.images[0] : `${BACKEND_URL}/${item.images[0].replace(/\\/g, '/')}`} 
                          alt={item.name} 
          ...
          <div className="gallery-modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="gallery-main-view">
              {selectedGalleryItem.images && selectedGalleryItem.images.length > 0 ? (
                <>
                  <img 
                    src={selectedGalleryItem.images[currentImageIndex].startsWith('http') ? selectedGalleryItem.images[currentImageIndex] : `${BACKEND_URL}/${selectedGalleryItem.images[currentImageIndex].replace(/\\/g, '/')}`} 
                    alt="Product"
